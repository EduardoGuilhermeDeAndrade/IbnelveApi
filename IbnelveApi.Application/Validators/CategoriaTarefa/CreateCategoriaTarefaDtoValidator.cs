...
/// <summary>
/// Validador para CreateCategoriaTarefaDto
/// </summary>
public class CreateCategoriaTarefaDtoValidator : AbstractValidator<CreateCategoriaTarefaDto>
{
    public CreateCategoriaTarefaDtoValidator()
    {
        RuleFor(x => x.Nome)
            .NotEmpty()
